...
namespace S.P_HW5
{
    public partial class Form1 : Form
    {
        ...
        OutInfo outputSettings;

        public Form1()
        {
            InitializeComponent();
            outputSettings = new OutInfo();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Task.Run(() =>
            {
                ...
                {
                    RefreshTextBox(textBox1, "Операція зупинена!");
                    return;
                }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            sfd.Filter = "Текстові документи(*.txt)|*.txt";
            sfd.FileName = $"OutInfo.txt";
